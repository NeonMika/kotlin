 ...
 * @property sourceMap If this annotation was generated by the compiler from a [js] call, contains the debug info in the Source Map 3
 *   format that maps the offsets in [code] to the original Kotlin file.
 */
@PublishedApi
@Target(AnnotationTarget.FUNCTION, AnnotationTarget.PROPERTY_GETTER, AnnotationTarget.PROPERTY_SETTER)
@Suppress("unused") // Usages are generated by JsCodeOutliningLowering
internal annotation class JsFun(val code: String, val sourceMap: String = "")
